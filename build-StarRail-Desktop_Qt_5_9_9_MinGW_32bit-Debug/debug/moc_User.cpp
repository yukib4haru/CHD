...
QT_MOC_LITERAL(1, 5, 24), // "judgeUsernameAndpassword"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 8), // "UserInfo"
QT_MOC_LITERAL(4, 40, 4), // "user"
QT_MOC_LITERAL(5, 45, 12) // "registerUser"

    },
    "User\0judgeUsernameAndpassword\0\0UserInfo\0"
    "user\0registerUser"
};
...
void User::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->judgeUsernameAndpassword((*reinterpret_cast< UserInfo(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 1: { int _r = _t->registerUser((*reinterpret_cast< UserInfo(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
